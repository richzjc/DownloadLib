...
class SimpleSubscribeInfo(val sizeChangeMethod : List<SubscribeMethod>?, val pauseAllMethod : List<SubscribeMethod>?, val startAllMethod : List<SubscribeMethod>?, val pauseStart : List<SubscribeMethod>?) : SubscribeInfo {
